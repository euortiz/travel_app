                    ...
                    <div className='flexBetween flex-col'>
                        <div className='flex w-full flex-col'>
                            <div className='flexBetween w-full'>
                                <p className='regular-16 test-gray-20'>Destination</p>
                        ...
                        <div className='flex w-full flex-col'>
                            <p className='regular-16 test-gray-20'>Start track</p>
                            <h4 className='bold-20 mt-2 whitespace-nowrap'>Andaluzia, Spain</h4>
                        </div>
                    </div>
                </div>
            </div>
